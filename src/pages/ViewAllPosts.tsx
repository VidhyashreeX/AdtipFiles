    ...
    <div className="min-h-screen bg-[#f5f5ff]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="space-y-6">
          {posts.map((post) => (
            <div key={post.id} className="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 p-6 hover:shadow-md transition-shadow">
