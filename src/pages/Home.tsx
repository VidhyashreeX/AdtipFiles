...
const feedData = [
  {
    ...
    content: {
      ...
      description: "This new product is amazing! Check it out #ad #sponsored",
      views: "150K",
      likes: "12.5K",
      comments: 342,
      shares: 89,
  ...
  },
  {
    ...
    content: {
      ...
      description: "Beautiful sunset at the beach today! #travel #sunset",
      views: "75K",
      likes: "8.2K",
      comments: 156,
      shares: 45,
  ...
  },
  {
    ...
    content: {
      type: "video",
      thumbnail: "/placeholder.svg",
      description: "Unboxing the latest smartphone! What do you think?",
      views: "220K",
      likes: "18K",
      comments: 423,
      shares: 134,
