  ...
  return (
    <View style={styles.container}>
      <View style={styles.logoContainer}>
        <Image
          source={{
            uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnlOAv4A7EMx1oFmQ9mpCWcnVei-C8T61XgJKqzXkYhoj7cIwnEq9GJImmue-5CtLUMLk&usqp=CAU',
          }}
      ...
      <View style={styles.iconsContainer}>
        <TouchableOpacity
          style={[
            styles.iconButton,
            activeTab === 'profile' && styles.activeIconButton,
          ]}
        ...
        <TouchableOpacity
          style={[
            styles.iconButton,
            activeTab === 'shorts' && styles.activeIconButton,
          ]}
          onPress={navigateToShorts}>
          <Play size={24} color={activeTab === 'shorts' ? '#24d05a' : '#333'} />
        </TouchableOpacity>

        <TouchableOpacity
          style={[
            styles.iconButton,
            activeTab === 'analytics' && styles.activeIconButton,
          ]}
        ...
        <TouchableOpacity
          style={[
            styles.iconButton,
            activeTab === 'search' && styles.activeIconButton,
          ]}
