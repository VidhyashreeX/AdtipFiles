...
CREATE TABLE `channel_details` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `channel_id` (`user_id`,`channel_id`)
) ENGINE=InnoDB AUTO_INCREMENT=15140 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dump completed on 2025-11-11 10:45:30
