...
CREATE TABLE `user_post_comments` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_user_post_comments_postId` (`postId`),
  KEY `fk_user_post_comments_userId` (`user_id`),
  KEY `idx_post_comments` (`postId`,`created_at` DESC),
...
-- Dump completed on 2025-11-11 10:46:20
