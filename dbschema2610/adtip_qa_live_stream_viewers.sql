...
CREATE TABLE `live_stream_viewers` (
  ...
  CONSTRAINT `live_stream_viewers_ibfk_1` FOREIGN KEY (`stream_id`) REFERENCES `live_streams` (`id`) ON DELETE CASCADE,
  CONSTRAINT `live_stream_viewers_ibfk_2` FOREIGN KEY (`viewer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-10-26 13:04:32
