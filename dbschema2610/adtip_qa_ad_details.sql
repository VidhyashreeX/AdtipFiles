...
CREATE TABLE `ad_details` (
  ...
  `ad_like_payment` double DEFAULT NULL,
  `is_active` int DEFAULT NULL,
  `ad_view_payment` double DEFAULT NULL,
  `createddate` datetime DEFAULT NULL,
  `updateddate` datetime DEFAULT NULL,
  `is_view_createddate` datetime DEFAULT NULL,
  `is_like_createddate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2025-10-26 13:05:20
