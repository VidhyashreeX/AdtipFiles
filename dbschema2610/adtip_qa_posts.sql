...
CREATE TABLE `posts` (
  ...
  `adtip_wallet_credit_status` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `idx_user_posts` (`user_id`,`created_at` DESC),
  KEY `idx_promoted_posts` (`is_promoted`,`created_at` DESC),
  KEY `idx_category_posts` (`video_category_id`,`created_at` DESC),
...
-- Dump completed on 2025-10-26 13:05:37
