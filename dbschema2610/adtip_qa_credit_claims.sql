...
--
-- Table structure for table `credit_claims`
--
...
CREATE TABLE `credit_claims` (
  ...
  `content_type` enum('post','tiptube','tipshorts') NOT NULL,
  `viewer_user_id` int DEFAULT NULL,
  `claimed_amount` decimal(10,2) DEFAULT '2.00',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_claim` (`share_id`,`viewer_user_id`),
  KEY `idx_share_id` (`share_id`),
  KEY `idx_content_viewer` (`content_id`,`viewer_user_id`),
...
-- Dump completed on 2025-10-26 13:01:39
