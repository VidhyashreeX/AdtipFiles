...
--
-- Table structure for table `cpx_research_transactions`
--

DROP TABLE IF EXISTS `cpx_research_transactions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cpx_research_transactions` (
  `id` int NOT NULL AUTO_INCREMENT,
  `cpx_trans_id` varchar(255) NOT NULL,
  ...
  `status` enum('pending','completed','reversed','failed') DEFAULT 'pending',
  `subid_1` varchar(255) DEFAULT NULL,
  `subid_2` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2025-10-26 13:04:42
