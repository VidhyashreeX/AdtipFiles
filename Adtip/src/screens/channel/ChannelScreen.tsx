...
const ChannelScreen: React.FC = () => {
  ...
  const loadChannelData = async () => {
    try {
      ...
      const mockChannelInfo: ChannelInfo = {
        ...
        description: "Welcome to my channel! I create amazing content about technology, tips, and tutorials.",
  ...
  const renderVideoItem = ({ item }: { item: Video }) => (
    <TouchableOpacity 
      style={[styles.videoItem, { borderBottomColor: colors.border.light }]}
      onPress={() => navigation.navigate('Video' as never, { videoId: item.id } as never)}
    >
    ...
    <View style={styles.aboutContainer}>
      ...
      <View style={styles.statsGrid}>
        <View style={styles.statItem}>
          ...
          <Text style={[styles.statLabel, { color: colors.text.secondary }]}>Subscribers</Text>
        </View>
        <View style={styles.statItem}>
          <Text style={[styles.statNumber, { color: colors.text.primary }]}>
            {formatNumber(channelInfo?.videoCount || 0)}
          </Text>
          <Text style={[styles.statLabel, { color: colors.text.secondary }]}>Videos</Text>
        </View>
        <View style={styles.statItem}>
          <Text style={[styles.statNumber, { color: colors.text.primary }]}>
            {formatNumber(channelInfo?.totalViews || 0)}
          </Text>
          <Text style={[styles.statLabel, { color: colors.text.secondary }]}>Total Views</Text>
        </View>
      </View>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={[styles.channelHeader, { backgroundColor: colors.background }]}>
          <View style={styles.channelInfoRow}>
            ...
            <View style={styles.channelDetails}>
              ...
              <Text style={[styles.channelUsername, { color: colors.text.secondary }]}>
          ...
          <TouchableOpacity
            style={[
              ...
              {
                backgroundColor: channelInfo.isSubscribed ? colors.border.light : colors.primary
              }
            ]}
          ...
          >
            {isSubscribing ? (
              ...
              <Text style={[
                ...
                {
                  color: channelInfo.isSubscribed ? colors.text.primary : colors.white
                }
              ]}>
        ...
        <View style={[styles.tabContainer, { borderBottomColor: colors.border.light }]}>
          <TouchableOpacity
            style={[
              styles.tab,
              selectedTab === 'videos' && { borderBottomColor: colors.primary, borderBottomWidth: 2 }
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.tab,
              selectedTab === 'about' && { borderBottomColor: colors.primary, borderBottomWidth: 2 }
            ]}
