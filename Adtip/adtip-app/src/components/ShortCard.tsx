...
export default function ShortCard({ short, isActive }: ShortCardProps) {
  ...
  return (
    <View style={[styles.container, { height: SCREEN_HEIGHT }]}>
      ...
      <View style={[styles.overlay, { paddingTop: HEADER_HEIGHT, paddingBottom: insets.bottom, zIndex: 2 }]}>
        ...
        <View style={[styles.actions, { bottom: 32 + insets.bottom }]}>
          <TouchableOpacity style={styles.actionButton} onPress={handleLike}>
            <Heart size={28} color={liked ? '#24d05a' : '#FFF'} fill={liked ? '#24d05a' : 'transparent'} />
