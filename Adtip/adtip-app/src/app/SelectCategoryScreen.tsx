...
export default function SelectCategoryScreen() {
  ...
  const categories = [
    'art & design', 'beauty transformations', 'business & marketing', 'comedy & memes',
    'creative edits', 'daily routines', 'dance', 'digital art', 'digital marketing',
    'educational & informative', 'entertainment & creative content', 'entrepreneurship',
    'exploring new places', 'fashion & beauty', 'fitness & sports', 'food & cooking',
    'interesting discoveries', 'learning new skills', 'life advice', 'lifestyle & personal content',
    'makeup tutorials', 'motivation & self-improvement', 'motivational speeches', 'movie clips',
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subTitle}>Tell us what piques your curiosity and passions for your post</Text>
