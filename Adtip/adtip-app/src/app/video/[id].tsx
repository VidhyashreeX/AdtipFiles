...
import { ArrowLeft, ThumbsUp, MessageSquare, Share2, Heart } from 'lucide-react-native';
...
export default function VideoScreen() {
  ...
  const { isVideoLiked, likeVideo, unlikeVideo, isChannelFollowed, followChannel, unfollowChannel } = useUserStore();
      ...
      <ScrollView>
        ...
        <View style={styles.infoSection}>
          ...
          <Text style={styles.viewsText}>
            {video.views.toLocaleString()} views • {new Date(video.postedAt).toLocaleDateString()}
          </Text>
          
          <View style={styles.actionsContainer}>
            <TouchableOpacity style={styles.actionButton} onPress={handleLike}>
              <ThumbsUp size={22} color={isLiked ? '#FF0000' : '#333'} fill={isLiked ? '#FF0000' : 'transparent'} />
        ...
        <TouchableOpacity style={styles.channelSection} onPress={navigateToChannel}>
          <Image source={{ uri: video.channel.avatar }} style={styles.channelAvatar} />
          <View style={styles.channelInfo}>
            <Text style={styles.channelName}>
              {video.channel.name}
              {video.channel.verified && <Text style={styles.verifiedBadge}> ✓</Text>}
            </Text>
