...
export default function AnalyticsScreen() {
  ...
  const [isAnalyticsEnabled, setIsAnalyticsEnabled] = useState<boolean>(channel?.isPremium ?? false);
      ...
      <ScrollView>
        ...
        <View style={styles.toggleSection}>
          ...
          <TouchableOpacity 
            ...
            style={channel.isPremium ? styles.toggleSwitchDisabled : styles.toggleSwitch}
          >
            <View style={styles.toggleSwitch}>
              <View
                style={[
                  styles.toggleActive,
                  isAnalyticsEnabled ? styles.toggleActiveOn : styles.toggleActiveOff,
                ]}
              />
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.statsSection}>
          <Text style={styles.statTitle}>Total Channel Views - {channel.totalViews}</Text>
        ...
        <View style={styles.infoSection}>
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoContent}>
              <Text style={styles.infoTitle}>How to Earn as a Content Creator on AdTip?</Text>
              <View style={styles.infoList}>
                ...
                <View style={styles.infoItem}>
                  <Text style={styles.infoCheckmark}>✓</Text>
                  <Text style={styles.infoText}>
                    Note: These earning features are only available for Premium users.
                  </Text>
                </View>
              </View>
            </View>
