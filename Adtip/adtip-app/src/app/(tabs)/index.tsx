    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        >
          ...
          />
          {loading.stories ? (
            <ActivityIndicator size="small" color="#24d05a" style={styles.storyLoader} />
          ) : stories.length === 0 ? (
        ...
        <View style={styles.postsContainer}>
          {loading.posts ? (
            <ActivityIndicator size="large" color="#24d05a" style={styles.loader} />
          ) : error ? (
            ...
            posts.map((post) => (
              <PostItem
                ...
                profileImage={post.user_profile_image || 'https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg'}
