...
export default function TipTubeUploadScreen() {
      ...
      <View style={earningStyles.container}>
        ...
        <View style={earningStyles.packagesContainer}>
          <View style={[earningStyles.packageCard, earningStyles.freeCard]}>
            <Text style={[earningStyles.packageTitle, { color: '#ff4d4f' }]}>Free</Text>
            <View style={earningStyles.packageItem}>
              <Text style={[earningStyles.checkmark, { color: '#ff4d4f' }]}>✗</Text>
              <Text style={earningStyles.packageText}>No earnings for uploads on TipTube & TipShort</Text>
            </View>
            <View style={earningStyles.packageItem}>
              <Text style={[earningStyles.checkmark, { color: '#24d05a' }]}>✓</Text>
              <Text style={earningStyles.packageText}>Free Video upload only</Text>
            </View>
            <View style={earningStyles.packageItem}>
              <Text style={[earningStyles.checkmark, { color: '#24d05a' }]}>✓</Text>
              <Text style={earningStyles.packageText}>Earn 0.06 paisa per ad view</Text>
            </View>
            <View style={earningStyles.packageItem}>
              <Text style={[earningStyles.checkmark, { color: '#24d05a' }]}>✓</Text>
              <Text style={earningStyles.packageText}>Fan Call to earn 0.60 paisa (coming soon)</Text>
            </View>
            <View style={earningStyles.packageItem}>
              <Text style={[earningStyles.checkmark, { color: '#24d05a' }]}>✓</Text>
              <Text style={earningStyles.packageText}>Fan Video to earn 1 rs/- (coming soon)</Text>
            </View>
          </View>

          <View style={[earningStyles.packageCard, earningStyles.premiumCard]}>
            <Text style={[earningStyles.packageTitle, { color: '#24d05a' }]}>Premium</Text>
            <View style={earningStyles.packageItem}>
              <Text style={[earningStyles.checkmark, { color: '#24d05a' }]}>✓</Text>
              <Text style={earningStyles.packageText}>Earnings for uploads on TipTube & TipShort</Text>
            </View>
            <View style={earningStyles.packageItem}>
              <Text style={[earningStyles.checkmark, { color: '#24d05a' }]}>✓</Text>
              <Text style={earningStyles.packageText}>Free & Paid video upload</Text>
            </View>
            <View style={earningStyles.packageItem}>
              <Text style={[earningStyles.checkmark, { color: '#24d05a' }]}>✓</Text>
              <Text style={earningStyles.packageText}>To earn upto 10000/- rs per ad view</Text>
            </View>
            <View style={earningStyles.packageItem}>
              <Text style={[earningStyles.checkmark, { color: '#24d05a' }]}>✓</Text>
              <Text style={earningStyles.packageText}>Fan call to earn 4 rs/- (coming soon)</Text>
            </View>
            <View style={earningStyles.packageItem}>
              <Text style={[earningStyles.checkmark, { color: '#24d05a' }]}>✓</Text>
              <Text style={earningStyles.packageText}>Fan Video to earn 8 rs/- (coming soon)</Text>
            </View>
          </View>
        </View>
  ...
  return (
    <View style={uploadStyles.container}>
      ...
      <TouchableOpacity style={[uploadStyles.button, uploadStyles.galleryButton]} onPress={handleGalleryPress}>
      ...
      <TouchableOpacity style={uploadStyles.uploadButton} onPress={handleUploadPress}>
